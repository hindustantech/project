        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <div className="flex items-center gap-4">
              <h1 className="text-[30px] lg:text-[32px] font-bold text-[#3bc191] uppercase tracking-wide whitespace-nowrap">
                HIRE DEDICATED
              </h1>
              <div className="flex-1 border-t-2 border-[#3bc191]"></div>
            </div>

            <h2 className="text-[60px] font-extrabold text-[#1a2e35] leading-none mt-2">
              DEVELOPERS
            </h2>
            <p className="text-[#1a2e35] text-lg font-semibold mt-2">
            ...
            <div className="flex items-center gap-4 mt-8">
              <Button className="bg-[#FF7F7F] hover:bg-[#ff6a6a] text-white rounded-md px-6 py-3 text-sm font-semibold">
                View More ↗
              </Button>
